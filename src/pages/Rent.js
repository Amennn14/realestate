...
function RentPage() {
  ...
  const handleSubmitOffer = (e) => {
    e.preventDefault();
    if (newOffer.title && newOffer.price && newOffer.location && newOffer.description && newOffer.image) {
      setRentOffers([
        ...rentOffers,
  ...
  const filteredOffers = rentOffers.filter((offer) => {
    ...
    const matchesMinPrice = filters.minPrice ? offer.price >= filters.minPrice : true;
    const matchesMaxPrice = filters.maxPrice ? offer.price <= filters.maxPrice : true;
